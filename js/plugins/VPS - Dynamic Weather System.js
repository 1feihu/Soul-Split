...
// ----------------------------------------------------------------------------------------
/*:
* @plugindesc v4.0 RMMV 1.3.1 An extended weather system for RMMV with different effects and behaviors.
* @author Soulpour777
*
@help
...
*/
    ...
    Soulpour777.WeatherEffectsSystem.pluginCommand = Game_Interpreter.prototype.pluginCommand;
    Game_Interpreter.prototype.pluginCommand = function(command, args) {
    	Soulpour777.WeatherEffectsSystem.pluginCommand.call(this, command, args);
    ...
    VPS_DynamicWeatherSystem.prototype = Object.create(PIXI.Container.prototype);
